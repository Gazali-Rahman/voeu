<section class="max-w-md mx-auto bg-black h-screen relative overflow-hidden flex flex-col items-center py-12">
    ...
    <div class="relative z-10 flex flex-col items-center text-center mt-[5vh] mb-auto w-[85%] max-w-[320px]">
        ...
        <p class="font-abigail text-4xl text-white tracking-tighter leading-none mb-2 drop-shadow-lg wrap-break-word">
