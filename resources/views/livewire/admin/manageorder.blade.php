                            ...
                            <div class="flex justify-end items-center gap-2">
                                ...
                                @else
                                    <div class="flex items-center gap-3">
                                        <span class="text-[8px] uppercase tracking-widest text-gray-300 italic">No
                                            Action Required</span>

                                        {{-- Tombol Delete Order --}}
                                        <button wire:click="deleteOrder({{ $order->id }})"
                                            wire:confirm="Menghapus Order akan menghapus Undangan & Asset file di dalamnya. Lanjutkan?"
