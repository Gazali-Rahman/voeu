                ...
                @if ($generatedLink)
                    <div x-data="{ copied: false }"
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="https://wa.me/?text={{ urlencode($waMessage) }}" target="_blank"
                                class="flex-1 bg-green-500 text-white py-4 rounded-xl text-[9px] uppercase tracking-widest font-bold text-center hover:bg-green-600 transition-all shadow-lg shadow-green-500/10 flex items-center justify-center gap-2">
