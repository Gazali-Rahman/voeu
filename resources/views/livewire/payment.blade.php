<div class="min-h-screen bg-[#F9F8F6] py-20 flex flex-col items-center font-sans px-4">
    ...
    <div
        ...
        <div class="pt-6 border-t border-neutral-50 flex justify-between items-end">
            <div>
    ...
    <div class="w-full max-w-md">
            ...
            <div class="space-y-6">
                ...
                <button wire:click="processPayment" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove wire:target="processPayment"
                        class="text-[11px] uppercase tracking-[0.6em] font-bold">
                        Bayar Sekarang
                    </span>
        ...
        @elseif($order->status === 'expired' || $order->status === 'failed')
            ...
            <div class="text-center space-y-6">
                ...
                <a href="{{ route('home') }}"
                    class="block w-full border border-neutral-200 text-[#1a1a1a] py-6 rounded-2xl text-[10px] uppercase tracking-[0.5em] font-bold hover:bg-neutral-50 transition-all text-center">
                    Back to Home
                </a>
            </div>
        @else
            ...
            <div class="text-center space-y-6">
                ...
                <a href="{{ route('my-orders') }}" wire:navigate
                    class="block w-full bg-[#1a1a1a] text-white py-6 rounded-2xl text-[10px] uppercase tracking-[0.5em] font-bold hover:bg-black transition-all text-center shadow-lg shadow-black/5">
                    My Orders
                </a>
            </div>
        @endif
