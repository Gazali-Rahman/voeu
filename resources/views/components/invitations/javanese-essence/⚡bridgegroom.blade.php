    ...
    <div class="relative z-10 flex flex-col items-center">
        ...
        <div x-data="{ show: false }" x-intersect="show = true" class="relative w-full mb-40 flex flex-col items-start">
            ...
            <div x-show="show" x-transition:enter="transition ease-in-out duration-1500 delay-1500"
                ...
                {{-- Section Instagram --}}
                @if (!empty($invitation->content['instagram_pria']))
                    <div class="mt-3">
                        {{-- ltrim digunakan untuk berjaga-jaga jika user input pakai '@' (cth: @username), link tetap valid --}}
                        <a href="https://instagram.com/{{ ltrim($invitation->content['instagram_pria'], '@') }}"
                            target="_blank"
                            class="inline-flex items-center gap-1.5 text-[#5a3a2e]/80 hover:text-[#5a3a2e] transition-colors duration-300">
                            ...
                            <span
                                class="font-poppins text-[10px] tracking-wider">{{ $invitation->content['instagram_pria'] }}</span>
                        </a>
                    </div>
                @endif
            </div>
        ...
        <div x-data="{ show: false }" x-intersect="show = true" class="relative w-full mb-20 flex flex-col items-end">
            ...
            <div x-show="show" x-transition:enter="transition ease-in-out duration-1500 delay-1500"
                ...
                @if (!empty($invitation->content['instagram_wanita']))
                    <div class="mt-3">
                        {{-- ltrim digunakan untuk berjaga-jaga jika user input pakai '@' (cth: @username), link tetap valid --}}
                        <a href="https://instagram.com/{{ ltrim($invitation->content['instagram_wanita'], '@') }}"
                            target="_blank"
                            class="inline-flex items-center gap-1.5 text-[#5a3a2e]/80 hover:text-[#5a3a2e] transition-colors duration-300">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
                            ...
                            <span
                                class="font-poppins text-[10px] tracking-wider">{{ $invitation->content['instagram_wanita'] }}</span>
                        </a>
                    </div>
                @endif
            </div>
