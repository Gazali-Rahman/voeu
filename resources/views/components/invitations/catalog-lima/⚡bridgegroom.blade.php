...
<section class="max-w-md mx-auto bg-[#EAE8E3] relative py-20 px-4">
            ...
            <div class="flex items-start gap-6">
                <div class="relative w-[55%] aspect-[4/5] bg-neutral-300 shadow-sm ml-2">
                    ...
                    <div class="absolute -inset-3 pointer-events-none opacity-40">
                        <div class="absolute top-0 left-0 w-3 h-3 border-t-[1px] border-l-[1px] border-black"></div>
                        <div class="absolute bottom-0 right-0 w-3 h-3 border-b-[1px] border-r-[1px] border-black"></div>
                    </div>
                </div>
                ...
                <div class="flex-1 pt-4">
                    <div class="font-mono text-[7px] tracking-[0.3em] text-black/40 mb-2 uppercase italic">Verified
                        Bride</div>
                    <h2 class="font-abigail text-3xl text-black/80 leading-none">Sari<br>Rahmawati</h2>
        ...
        <div class="relative">
            ...
            <div class="flex flex-row-reverse items-start gap-6">
                <div class="relative w-[55%] aspect-[4/5] bg-neutral-300 shadow-sm mr-2">
                    ...
                    <div class="absolute -inset-3 pointer-events-none opacity-40">
                        <div class="absolute top-0 right-0 w-3 h-3 border-t-[1px] border-r-[1px] border-black"></div>
                        <div class="absolute bottom-0 left-0 w-3 h-3 border-b-[1px] border-l-[1px] border-black"></div>
                    </div>
                </div>
                ...
                <div class="flex-1 pt-4 text-right">
                    <div class="font-mono text-[7px] tracking-[0.3em] text-black/40 mb-2 uppercase italic">Verified
                        Groom</div>
                    <h2 class="font-abigail text-3xl text-black/80 leading-none">Romi<br>Ardiansyah</h2>
    ...
    <div
        ...
        <div class="flex gap-2">
            ...
            <span class="px-1 border border-black bg-black text-[#EAE8E3]">12.12.26</span>
        </div>
    </div>
